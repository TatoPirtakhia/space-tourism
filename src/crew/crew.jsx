    ...
    <div className="crew">
      ...
      <div className="desktop_crew">
        ...
        <img
          ...
          height={572}
          className="crew_tablet"
          alt="crew"
        />
        <div className="crew_desktop">
          <img src={crew.images.webp} height={700}  alt="crew" />
        </div>
      </div>
    </div>
  );
